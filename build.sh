...
/opt/gbdk/bin/lcc -Wa-l -Wl-m -Wl-j -Wm-yn"KNIGHT" -Wm-yc -Wl-yt1 -Wl-yo4 -Wl-ya0 -o knight.gb src/knight_sprites.o main.o src/functions.o src/knight_tiles.o src/gameCharacter.o src/ForestBG.o src/GameOverBackground.o audio/output.o audio/gbt_player.o audio/gbt_player_bank1.o
