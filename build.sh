...
/opt/gbdk/bin/lcc -Wa-l -Wl-m -Wl-j -Wm-yn"KNIGHT" -Wm-yc -o knight.gb src/knight_sprites.o main.o src/functions.o src/characters.o src/windowLayer.o src/knight_tiles.o src/gameCharacter.o src/ForestBG.o src/GameOverBackground.o audio/output.o audio/gbt_player.o audio/gbt_player_bank1.o
